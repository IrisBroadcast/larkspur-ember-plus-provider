...
namespace EmberPlusProviderLib.EmberHelpers
{
    ...
    {
        /*
         * Det här är en kopia av metoderna i  EmberLib.Glow.InternalTools
         * I orginal är metoderna interna och därför inte nåbara utanför det egna biblioteket.
         *
         * Implementationen är medvetet inte uppdaterad för att stödja svenska tecken för att ha identiskt beteende som i LAWOs kod.
         *
         */
