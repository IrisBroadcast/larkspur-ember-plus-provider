...
//        public Dispatcher ProviderDispatcher { get; protected set; }
//        protected GlowListener listener;

//        public EmberTreeProvider(int port = 9003,
//            string emberTreeIdentifier = "TreeIdentifier",
//            string emberTreeDescription = "TreeDescription",
...
//            ProviderDispatcher = new Dispatcher() { Root = Node.CreateRoot() };
//            ProviderRoot = new Node(1, ProviderDispatcher.Root, emberTreeIdentifier) { Description = emberTreeDescription };
//            listener = new GlowListener(port, maxPackageLength, ProviderDispatcher);
...
//        {
//            var element = Provider.ProviderDispatcher.Root.ResolveChild(path, out var dynamicPathHandler);
//            return element as T;
//        }

//        protected T GetElement<T>(string identifierPath) where T : class
//        {
//            var element = Provider.ProviderDispatcher.Root.ResolveChild(identifierPath);
//            return element as T;
//        }
